...
function loadMediaPartner() {
    const mediaPartnersData = {
        ...
        PICname: ["TAN CHIEN LING", 
                  "LIM CHIEW HUI",
                  "NUR DAMIA BINTI MOHAMAD ZAIDI",
                  "CHUBAASINY A/P ESWARARAO",
                  "TAN YING XIN",
                  "Swee Hao Feng",
                  "TEH XIAO HE",
                  "KISHERN A/L SURAS KUMAR",
                  "VICKY TAN",
                  "CHANG CHI SAN",
                  "NURQISTINA ATHIRAH SYAFEAH BINTI MAHAMAD SHUKRI",
                  "ISHWAAR ANANDHE THURAI",
                  "AIMAN HAKIMI BIN HARUN",
                  "MOHAMMAD FARIHIN BIN ROSLAN",
                  "Khor Yan Ru",
                  "LUVENA GOH YEN CHI ",
                  "OOI RUI ZHE",
                  "MUHAMMAD NAJMI BIN MOHD ALI HANAFIAH",
                  "MD SAMIUL BASHAR APON",
                  "Ooi Khai Shen",
                  "LIEW YU EN",
                  "MUHAMMAD DHAFA WARGANEGARA",
                  "SOFIYAH BINTI MOHD MISRI ",
                  "ADIB AZMI",
                  "YONG MAE JHIN (CELISA)",
                  "MUHAMMAD NUR AMJADH BIN ASABDEEN",
                  "TANG JING YEE",
                  "ELYSIA YUNG SHI XI",
                  "CHIN PEI KANG",
                  ...
                  "Chan Jun Hong (Cozy)",
                  "NG PHEY QEE",
                  "ALWIN CHONG WEI SHEN",
                  "SITHARTEN A/L RAVI",
                  "Abel Nathanel Hutapea",
                  "Whitney Lim Wan Yee",
                  "PADMA PIREEYAA A/P S SOUNDRA RAJAN",
                  "DASHAYNE LUM",
                  "CHIN PEI KANG",
                  "AMIN IKHWAN BIN AHMAD NIZAM",
                  "TINES SUBRAMANIAM",
                  "SITI KHADIJAH SAFIYYAH",
                  "Alya Mohd",
                  "LOW REN JING",
        ...
        email: ["gdgum.prteam@gmail.com", 
                "chiewhuilim@gmail.com",
                "keusahawanan@um.edu.my",
                "gdsc.segi@gmail.com",
                "yingxin0411@gmail.com",
                "haofeng0903@gmail.com",
                "engineeringsociety66@gmail.com",
                "kishernkumar7@gmail.com",
                "imecheum.prm@gmail.com",
                "changcs2004@gmail.com",
                "qisathsyaf07@gmail.com",
                "22107343@siswa.um.edu.my",
                "iumdisruptkktb@gmail.com",
                "mohdfarihinroslan@gmail.com",
                "yvesmotland@gmail.com",
                "myouth.fintech.externalrelations@gmail.com",
                "ooiruizhe@gmail.com",
                "a200844@siswa.ukm.edu.my",
                "bashar.m@graduate.utm.my",
                "ksooi1231@gmail.com",
                "yuenliew.aot@gmail.com",
                "wndhafa@gmail.com",
                "fsktm.comssa@upm.edu.my",
                "22003156@siswa.um.edu.my",
                "sunanalyticssociety@gmail.com",
                "a199991@siswa.ukm.edu.my",
                "jimmytang9940@gmail.com",
                "shixiii31@gmail.com",
                "rec.um2425@gmail.com",
                "marissajmili@gmail.com",
                "cozy.fun64@gmail.com",
                "ngpheyqee@gmail.com",
                "alwin2710@1utar.my",
                "umdac@um.edu.my",
                "xmumai@gmail.com",
                "whitneylim0719@gmail.com",
                "padma.pireeyaa1115@gmail.com",
                "sunwaybcc@gmail.com",
                "mazecrazeum@gmail.com",
                "enginiusmedia@gmail.com",
                "tines0910@gmail.com",
                "muhammadhilman30304@gmail.com",
                "alya@myunilah.com",
                "renjing2606@gmail.com",
                "nurfatihah798@gmail.com",
                "harizhakim85@gmail.com",
                "0810jiaying@gmail.com",
        ],
        instagram: ["@gdg.um", 
                    "@musa.soit",
                    "@usahawan_um",
    ...
    for (let index = 0; index < mediaPartnersData.name.length; index++) {
        ...
        contact.classList.add('contact-us', 'mb-1');
        div.appendChild(contact);
        
        const contactDetail = document.createElement('div');
        contactDetail.id = "contact-detail";
        contactDetail.classList.add('justify-content-center', 'align-items-center');
        
            const PICcontact = document.createElement('div');
                const PICname = document.createElement('p');
                PICname.innerHTML = mediaPartnersData.PICname[index];
                PICname.classList.add('mb-0');
                PICcontact.appendChild(PICname);

                const PICphone = document.createElement('p');
                PICphone.innerHTML = mediaPartnersData.PICphone[index];
                PICphone.classList.add('mb-0');
                PICcontact.appendChild(PICphone);
            contactDetail.appendChild(PICcontact);

            const or1Word = document.createElement('p');
            or1Word.innerHTML = "OR";
            or1Word.classList.add('mx-4', 'my-2');
            contactDetail.appendChild(or1Word);

            const email = document.createElement('p');
            email.innerHTML = mediaPartnersData.email[index];
            email.classList.add('mb-0');
            contactDetail.appendChild(email);

            const or2Word = document.createElement('p');
            or2Word.innerHTML = "OR";
            or2Word.classList.add('mx-4', 'my-2');
            contactDetail.appendChild(or2Word);

            const instagram = document.createElement('p');
            instagram.innerHTML = mediaPartnersData.instagram[index];
            instagram.classList.add('mb-0');
            contactDetail.appendChild(instagram);
        
        div.appendChild(contactDetail);
    }
};
